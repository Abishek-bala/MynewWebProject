...
public class InvoiceTransDAOImpl implements InvoiceTransDAO,Cloneable{
	...
	private static InvoiceTransDAOImpl invoiceTransDaoImpl;
	
	public static InvoiceTransDAOImpl getInvoiceTransDaoImpl() {
		if(invoiceTransDaoImpl==null) {
			invoiceTransDaoImpl=new InvoiceTransDAOImpl();
		}
		return invoiceTransDaoImpl.getClone();
	}
	
	public InvoiceTransDAOImpl getClone() {
		try {
